  ...
  spec {
    ...
    template {
      ...
      spec {
        ...
        container {
          name  = "airspace-history-calculator"
          image = "${var.docker_repo_region}-docker.pkg.dev/${var.docker_repo_project_id}/${var.docker_repo_name}/airspace_history_calculator:${var.airspace_history_calculator_tag}"
