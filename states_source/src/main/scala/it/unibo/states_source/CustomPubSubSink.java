 ...
 *
 * @param <MinimalState> type of PubSubSink messages to write
 */
public class CustomPubSubSink<MinimalState> extends RichSinkFunction<MinimalState> implements CheckpointedFunction {
    private static final Logger LOG = LoggerFactory.getLogger(CustomPubSubSink.class);
    ...
    private final SerializationSchema<MinimalState> serializationSchema;
    ...
    private CustomPubSubSink(
            Credentials credentials,
            SerializationSchema<MinimalState> serializationSchema,
            String projectName,
            String topicName,
     ...
     *
     * @param <MinimalState> Type of PubSubSink to create.
     */
    public static class PubSubSinkBuilder<MinimalState>
            implements ProjectNameBuilder<MinimalState>, TopicNameBuilder<MinimalState> {
        private SerializationSchema<MinimalState> serializationSchema;
        ...
        private PubSubSinkBuilder(SerializationSchema<MinimalState> serializationSchema) {
            this.serializationSchema = serializationSchema;
        }
         ...
         */
        public PubSubSinkBuilder<MinimalState> withCredentials(Credentials credentials) {
            this.credentials = credentials;
            return this;
        }

        @Override
        public TopicNameBuilder<MinimalState> withProjectName(String projectName) {
        ...
        @Override
        public PubSubSinkBuilder<MinimalState> withTopicName(String topicName) {
         ...
         * @return The current PubSubSinkBuilder instance
         */
        public PubSubSinkBuilder<MinimalState> withHostAndPortForEmulator(String hostAndPort) {
         ...
         */
        public CustomPubSubSink<MinimalState> build() throws IOException {
            if (credentials == null) {
                if (hostAndPort == null) {
    ...
    public static class SerializationSchemaBuilder {
         ...
         * PubSubMessages.
         */
        public <MinimalState> ProjectNameBuilder<MinimalState> withSerializationSchema(
                SerializationSchema<MinimalState> deserializationSchema) {
            return new PubSubSinkBuilder<>(deserializationSchema);
        }
    }

    /** Part of {@link PubSubSinkBuilder} to set required fields. */
    public interface ProjectNameBuilder<MinimalState> {
        /** Set the project name of the subscription to pull messages from. */
        TopicNameBuilder<MinimalState> withProjectName(String projectName);
    }

    /** Part of {@link PubSubSinkBuilder} to set required fields. */
    public interface TopicNameBuilder<MinimalState> {
        /** Set the subscription name of the subscription to pull messages from. */
        PubSubSinkBuilder<MinimalState> withTopicName(String topicName);
    }
